 ...
 ********************************************************************/
 ...
 class PriorityQueue<E, P> {
     ...
     public Node add(E e, P priority) {
        ...
        int addIndex = tree.size();
        Node newElement = new Node(e, priority, addIndex);
        tree.add(addIndex, newElement);
        // initially insert node into next empty space on tree, done in order to maintain shape
        pullUp(addIndex);
        // fix ordering with pullUp method
     ...
     public boolean contains(E e) {
        ...
        // check to see if any elements are equal to specified element, if so, change containsElement to true
